...
namespace Trabajo2
{
    public partial class AgregarAsignatura : Form
    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            {
                db.OpenConnection();
                var command = new SqlCommand("UPDATE Alumnos SET Nombre = @Nombre, ApellidoPat = @ApellidoPat, ApellidoMat = @ApellidoMat, Email = @Email, NumeroMatricula = @NumeroMatricula " + "WHERE IDAlumno = @IDAlumno", db.GetConnection());
